...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            store_passwd: env_1.envVars.SSL.SSL_SECRET_KEY,
...
const PaymentValidator = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, axios_1.default)({
            method: "GET",
            url: `${env_1.envVars.SSL.SSL_VALIDATION_API}?val_id=${payload.val_id}&store_id=${env_1.envVars.SSL.SSL_STORE_ID}&store_passwd=${env_1.envVars.SSL.SSL_SECRET_KEY}`
        });
        console.log(`SSL Validator response: ${response.data}`);
        yield payment_model_1.paymentModel.updateOne({ transactionId: payload.tran_id }, { paymentGateway: response.data }, { runValidators: true });
    }
    catch (error) {
        console.log(error);
        throw new appError_1.default(http_status_codes_1.StatusCodes.BAD_GATEWAY, `Payment validation failed: ${error.message}`);
    }
});
exports.sslServicess = {
    sslPaymentInit,
    PaymentValidator,
};
